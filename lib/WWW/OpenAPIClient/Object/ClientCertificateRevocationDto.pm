...
#
package WWW::OpenAPIClient::Object::ClientCertificateRevocationDto;
...
__PACKAGE__->class_documentation({description => '',
                                  class => 'ClientCertificateRevocationDto',
                                  required => [], # TODO
}                                 );

__PACKAGE__->method_documentation({
    'reason' => {
        datatype => 'CertificateRevocationReason',
        base_name => 'reason',
        description => '',
        format => '',
        read_only => '',
