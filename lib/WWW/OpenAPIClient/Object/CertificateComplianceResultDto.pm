...
#
package WWW::OpenAPIClient::Object::CertificateComplianceResultDto;
...
__PACKAGE__->class_documentation({description => 'Certificate compliance check result',
                                  class => 'CertificateComplianceResultDto',
                                  required => [], # TODO
}                                 );
...
__PACKAGE__->method_documentation({
    ...
    'rule_description' => {
        datatype => 'string',
        base_name => 'ruleDescription',
        description => 'Description of the rule',
        format => '',
        read_only => '',
            },
    'status' => {
        datatype => 'ComplianceRuleStatus',
        base_name => 'status',
        description => '',
        format => '',
        read_only => '',
