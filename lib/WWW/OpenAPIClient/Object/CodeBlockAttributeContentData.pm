...
#
package WWW::OpenAPIClient::Object::CodeBlockAttributeContentData;
...
__PACKAGE__->class_documentation({description => 'CodeBlock attribute content data',
...
__PACKAGE__->method_documentation({
    'language' => {
        datatype => 'ProgrammingLanguageEnum',
        base_name => 'language',
        description => '',
        format => '',
        read_only => '',
