...
#
package CZERTAINLY::Object::LocationDto;
...
__PACKAGE__->method_documentation({
    ...
    'support_multiple_entries' => {
        datatype => 'boolean',
        base_name => 'supportMultipleEntries',
        description => 'If the location supports multiple Certificates',
        format => '',
        read_only => '',
            },
    'support_key_management' => {
        datatype => 'boolean',
        base_name => 'supportKeyManagement',
        description => 'If the location supports key management operations',
        format => '',
        read_only => '',
            },
    'certificates' => {
        datatype => 'ARRAY[CertificateInLocationDto]',
...
__PACKAGE__->openapi_types( {
    ...
    'support_key_management' => 'boolean',
...
__PACKAGE__->attribute_map( {
    ...
    'entity_instance_uuid' => 'entityInstanceUuid',
    'entity_instance_name' => 'entityInstanceName',
    'attributes' => 'attributes',
    'custom_attributes' => 'customAttributes',
    'enabled' => 'enabled',
    'support_multiple_entries' => 'supportMultipleEntries',
    'support_key_management' => 'supportKeyManagement',
