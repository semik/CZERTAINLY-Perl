...
#
package WWW::OpenAPIClient::Object::RuleDetailDto;
...
__PACKAGE__->class_documentation({description => 'List of Rules in the Rule Trigger',
                                  class => 'RuleDetailDto',
                                  required => [], # TODO
}                                 );
