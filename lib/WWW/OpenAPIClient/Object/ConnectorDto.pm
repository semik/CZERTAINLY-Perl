...
#
package WWW::OpenAPIClient::Object::ConnectorDto;
...
__PACKAGE__->method_documentation({
    ...
    'function_groups' => {
        datatype => 'ARRAY[FunctionGroupDto]',
        base_name => 'functionGroups',
...
__PACKAGE__->openapi_types( {
    'uuid' => 'string',
    'name' => 'string',
    'function_groups' => 'ARRAY[FunctionGroupDto]',
    'url' => 'string',
    'auth_type' => 'AuthType',
    'auth_attributes' => 'ARRAY[ResponseAttributeDto]',
