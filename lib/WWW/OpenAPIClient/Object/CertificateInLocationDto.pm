...
#
package WWW::OpenAPIClient::Object::CertificateInLocationDto;
...
__PACKAGE__->class_documentation({description => 'List of Certificates in Location',
                                  class => 'CertificateInLocationDto',
                                  required => [], # TODO
}                                 );
...
__PACKAGE__->openapi_types( {
    ...
    'push_attributes' => 'ARRAY[ResponseAttributeDto]',
    'csr_attributes' => 'ARRAY[ResponseAttributeDto]',
    'with_key' => 'boolean'
} );
