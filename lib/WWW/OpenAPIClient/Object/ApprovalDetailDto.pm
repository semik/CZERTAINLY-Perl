...
#
package WWW::OpenAPIClient::Object::ApprovalDetailDto;
...
__PACKAGE__->method_documentation({
    ...
    'approval_steps' => {
        datatype => 'ARRAY[ApprovalDetailStepDto]',
        base_name => 'approvalSteps',
...
__PACKAGE__->openapi_types( {
    ...
    'object_uuid' => 'string',
    'approval_profile_name' => 'string',
    'approval_profile_uuid' => 'string',
    'expiry' => 'int',
    'description' => 'string',
    'approval_steps' => 'ARRAY[ApprovalDetailStepDto]'
} );
...
__PACKAGE__->attribute_map( {
    ...
    'approval_profile_uuid' => 'approvalProfileUuid',
    'expiry' => 'expiry',
