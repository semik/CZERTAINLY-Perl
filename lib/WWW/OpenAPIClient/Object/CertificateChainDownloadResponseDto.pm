...
#
package WWW::OpenAPIClient::Object::CertificateChainDownloadResponseDto;
...
__PACKAGE__->class_documentation({description => '',
                                  class => 'CertificateChainDownloadResponseDto',
                                  required => [], # TODO
}                                 );

__PACKAGE__->method_documentation({
    'format' => {
        datatype => 'CertificateFormat',
        base_name => 'format',
        description => '',
        format => '',
        read_only => '',
    ...
    'encoding' => {
        datatype => 'CertificateFormatEncoding',
        base_name => 'encoding',
        description => '',
        format => '',
        read_only => '',
