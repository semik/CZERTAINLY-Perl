...
#
package WWW::OpenAPIClient::Object::ApprovalProfileDetailDto;
...
__PACKAGE__->class_documentation({description => '',
                                  class => 'ApprovalProfileDetailDto',
                                  required => [], # TODO
}                                 );
...
__PACKAGE__->method_documentation({
    ...
    'approval_steps' => {
        datatype => 'ARRAY[ApprovalStepDto]',
...
__PACKAGE__->openapi_types( {
    ...
    'number_of_steps' => 'int',
    'associations' => 'int',
    'approval_steps' => 'ARRAY[ApprovalStepDto]'
} );
