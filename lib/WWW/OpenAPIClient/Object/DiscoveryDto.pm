...
#
package WWW::OpenAPIClient::Object::DiscoveryDto;
...
__PACKAGE__->method_documentation({
    ...
    'triggers' => {
        ...
        base_name => 'triggers',
        description => 'List of triggers to be triggered after the discovery is finished, triggers will be evaluated in given order',
        format => '',
        read_only => '',
            },
});
