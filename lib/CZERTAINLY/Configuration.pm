...
#
package CZERTAINLY::Configuration;
...
=head1 Name
        ...
        CZERTAINLY::Configuration - holds the configuration for all CZERTAINLY Modules
...
sub new {
    ...
    # base_url
    $p{base_url} //= 'http://localhost:45309';
