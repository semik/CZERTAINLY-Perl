...
#
package WWW::OpenAPIClient::Object::ConditionDto;
...
__PACKAGE__->class_documentation({description => 'List of conditions in the Rule',
                                  class => 'ConditionDto',
                                  required => [], # TODO
}                                 );
...
__PACKAGE__->method_documentation({
    ...
    'items' => {
        datatype => 'ARRAY[ConditionItemDto]',
        base_name => 'items',
