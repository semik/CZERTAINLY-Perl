...
#
package WWW::OpenAPIClient::Object::TokenInstanceStatusComponent;
...
__PACKAGE__->class_documentation({description => 'Components of the Token instance status',
                                  class => 'TokenInstanceStatusComponent',
                                  required => [], # TODO
}                                 );
