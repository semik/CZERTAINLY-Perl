...
#
package WWW::OpenAPIClient::Object::AttributeCallback;
...
__PACKAGE__->class_documentation({description => 'Optional definition of callback for getting the content of the Attribute based on the action',
...
__PACKAGE__->method_documentation({
    ...
    'callback_method' => {
        datatype => 'string',
        base_name => 'callbackMethod',
        description => 'HTTP method of the callback',
        format => '',
        read_only => '',
            },
    'mappings' => {
        datatype => 'ARRAY[AttributeCallbackMapping]',
        base_name => 'mappings',
