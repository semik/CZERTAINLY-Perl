...
#
package WWW::OpenAPIClient::Object::ResourceDto;
...
__PACKAGE__->method_documentation({
    ...
    'has_object_access' => {
        datatype => 'boolean',
        base_name => 'hasObjectAccess',
        description => 'If resource has Object access permissions. True &#x3D; Yes, False &#x3D; No',
        format => '',
        read_only => '',
            },
    'has_custom_attributes' => {
        datatype => 'boolean',
        base_name => 'hasCustomAttributes',
...
__PACKAGE__->openapi_types( {
    'resource' => 'Resource',
    'has_object_access' => 'boolean',
    'has_custom_attributes' => 'boolean',
    'has_groups' => 'boolean',
    'has_owner' => 'boolean',
    'has_events' => 'boolean',
    'has_rule_evaluator' => 'boolean'
} );
...
__PACKAGE__->attribute_map( {
    ...
    'has_rule_evaluator' => 'hasRuleEvaluator'
} );
