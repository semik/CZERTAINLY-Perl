...
#
package WWW::OpenAPIClient::Object::FunctionGroupDto;
...
__PACKAGE__->class_documentation({description => 'List of Function Groups implemented by the Connector',
                                  class => 'FunctionGroupDto',
                                  required => [], # TODO
}                                 );

__PACKAGE__->method_documentation({
    'function_group_code' => {
        datatype => 'FunctionGroupCode',
        base_name => 'functionGroupCode',
        description => '',
        format => '',
        read_only => '',
            },
...
__PACKAGE__->openapi_types( {
    'function_group_code' => 'FunctionGroupCode',
    'kinds' => 'ARRAY[string]',
    'end_points' => 'ARRAY[EndpointDto]',
    'uuid' => 'string',
    'name' => 'string'
} );
