...
#
package WWW::OpenAPIClient::Object::ResponseMetadataDto;
...
__PACKAGE__->class_documentation({description => 'Response metadata attribute instance with content',
...
__PACKAGE__->method_documentation({
    ...
    'source_objects' => {
        datatype => 'ARRAY[NameAndUuidDto]',
        base_name => 'sourceObjects',
...
__PACKAGE__->openapi_types( {
    ...
    'source_objects' => 'ARRAY[NameAndUuidDto]'
} );
