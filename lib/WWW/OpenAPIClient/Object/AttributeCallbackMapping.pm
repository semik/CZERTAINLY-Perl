...
#
package WWW::OpenAPIClient::Object::AttributeCallbackMapping;
...
__PACKAGE__->class_documentation({description => 'Mappings for the callback method',
...
__PACKAGE__->method_documentation({
    ...
    'targets' => {
        datatype => 'ARRAY[AttributeValueTarget]',
        base_name => 'targets',
