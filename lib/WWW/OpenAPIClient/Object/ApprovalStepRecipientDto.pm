...
#
package WWW::OpenAPIClient::Object::ApprovalStepRecipientDto;
...
__PACKAGE__->class_documentation({description => 'List of the approval recipient related for this step',
                                  class => 'ApprovalStepRecipientDto',
                                  required => [], # TODO
}                                 );
...
__PACKAGE__->method_documentation({
    'approval_recipient_uuid' => {
        datatype => 'string',
        base_name => 'approvalRecipientUuid',
...
__PACKAGE__->openapi_types( {
    'approval_recipient_uuid' => 'string',
    'user_uuid' => 'string',
    'username' => 'string',
...
__PACKAGE__->attribute_map( {
    'approval_recipient_uuid' => 'approvalRecipientUuid',
    'user_uuid' => 'userUuid',
    'username' => 'username',
