...
#
package WWW::OpenAPIClient::Object::NotificationInstanceRequestDto;
...
__PACKAGE__->class_documentation({description => '',
                                  class => 'NotificationInstanceRequestDto',
                                  required => [], # TODO
}                                 );
...
__PACKAGE__->method_documentation({
    ...
    'attribute_mappings' => {
        datatype => 'ARRAY[AttributeMappingDto]',
        base_name => 'attributeMappings',
...
__PACKAGE__->openapi_types( {
    ...
    'attribute_mappings' => 'ARRAY[AttributeMappingDto]',
    'name' => 'string',
