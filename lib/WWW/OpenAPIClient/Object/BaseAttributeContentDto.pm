...
#
package WWW::OpenAPIClient::Object::BaseAttributeContentDto;
...
__PACKAGE__->class_documentation({description => 'Base Attribute content definition',
                                  class => 'BaseAttributeContentDto',
                                  required => [], # TODO
}                                 );
