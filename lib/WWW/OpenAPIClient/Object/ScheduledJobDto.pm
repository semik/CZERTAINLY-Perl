...
#
package WWW::OpenAPIClient::Object::ScheduledJobDto;
...
__PACKAGE__->class_documentation({description => 'Scheduled jobs',
...
__PACKAGE__->openapi_types( {
    ...
    'one_time' => 'boolean',
    'system' => 'boolean',
    'last_execution_status' => 'SchedulerJobExecutionStatus'
} );
