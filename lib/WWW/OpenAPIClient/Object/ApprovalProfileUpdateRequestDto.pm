...
#
package WWW::OpenAPIClient::Object::ApprovalProfileUpdateRequestDto;
...
__PACKAGE__->class_documentation({description => '',
                                  class => 'ApprovalProfileUpdateRequestDto',
                                  required => [], # TODO
}                                 );
...
__PACKAGE__->method_documentation({
    ...
    'approval_steps' => {
        datatype => 'ARRAY[ApprovalStepRequestDto]',
...
__PACKAGE__->openapi_types( {
    'description' => 'string',
    'expiry' => 'int',
    'approval_steps' => 'ARRAY[ApprovalStepRequestDto]'
} );
