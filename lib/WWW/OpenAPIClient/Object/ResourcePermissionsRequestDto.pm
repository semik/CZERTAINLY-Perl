...
#
package WWW::OpenAPIClient::Object::ResourcePermissionsRequestDto;
...
__PACKAGE__->class_documentation({description => 'Resources',
                                  class => 'ResourcePermissionsRequestDto',
                                  required => [], # TODO
}                                 );
...
__PACKAGE__->method_documentation({
    ...
    'objects' => {
        datatype => 'ARRAY[ObjectPermissionsRequestDto]',
        base_name => 'objects',
