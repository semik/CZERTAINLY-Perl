...
#
package WWW::OpenAPIClient::Object::GroupAttribute;
...
__PACKAGE__->class_documentation({description => 'Group attribute and its content represents dynamic list of additional attributes retrieved by callback. Its content can not be edited and is not send in requests to store.',
...
__PACKAGE__->method_documentation({
    ...
    'content' => {
        datatype => 'ARRAY[BaseAttributeDto]',
        base_name => 'content',
