...
#
package WWW::OpenAPIClient::Object::TokenProfileDetailDto;
...
__PACKAGE__->method_documentation({
    ...
    'token_instance_status' => {
        datatype => 'TokenInstanceStatus',
        base_name => 'tokenInstanceStatus',
        description => '',
        format => '',
        read_only => '',
            },
...
__PACKAGE__->openapi_types( {
    ...
    'token_instance_status' => 'TokenInstanceStatus',
    'enabled' => 'boolean',
