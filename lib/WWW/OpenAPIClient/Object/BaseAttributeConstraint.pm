...
#
package WWW::OpenAPIClient::Object::BaseAttributeConstraint;
...
__PACKAGE__->class_documentation({description => 'Optional regular expressions and constraints used for validating the Attribute content',
...
__PACKAGE__->method_documentation({
    ...
    'type' => {
        datatype => 'AttributeConstraintType',
        base_name => 'type',
        description => '',
        format => '',
        read_only => '',
