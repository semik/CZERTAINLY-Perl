...
#
package WWW::OpenAPIClient::Object::UpdateUserRequestDto;
...
__PACKAGE__->method_documentation({
    ...
    'group_uuids' => {
        ...
        description => 'Groups UUIDs of the user (set to empty list to remove certificate from all groups)',
        format => '',
        read_only => '',
            },
    'certificate_data' => {
        datatype => 'string',
        base_name => 'certificateData',
