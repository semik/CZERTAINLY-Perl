...
usesub CZERTAINLY::Object;

use CZERTAINLY::ApiClient;

=head1 Name

    CZERTAINLY::ApiFactory - constructs APIs to retrieve CZERTAINLY objects

=head1 Synopsis

    package My::Petstore::App;

    use CZERTAINLY::ApiFactory;

    my $api_factory = CZERTAINLY::ApiFactory->new( ... ); # any args for ApiClient constructor

    # later...
    my $pet_api = $api_factory->get_api('Pet');

    # $pet_api isa CZERTAINLY::PetApi
...
my %_apis = map { $_ =~ /^CZERTAINLY::(.*)$/; $1 => $_ }
            grep {$_ =~ /Api$/}
            usesub 'CZERTAINLY';

=head1 new($api_client)

    create a new CZERTAINLY::ApiFactory instance with the given CZERTAINLY::ApiClient instance.

=head1 new(%parameters)

    Any parameters are optional, and are passed to and stored on the api_client object.

    See L<CZERTAINLY::ApiClient> and L<CZERTAINLY::Configuration> for valid parameters
