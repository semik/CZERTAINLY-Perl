...
#
package WWW::OpenAPIClient::Object::TriggerHistorySummaryDto;
...
__PACKAGE__->class_documentation({description => '',
                                  class => 'TriggerHistorySummaryDto',
                                  required => [], # TODO
}                                 );
...
__PACKAGE__->method_documentation({
    ...
    'association_object_uuid' => {
        datatype => 'string',
        base_name => 'associationObjectUuid',
    ...
    'objects_ignored' => {
        datatype => 'int',
        base_name => 'objectsIgnored',
        description => 'Number of objects matched by ignore triggers.',
        format => '',
        read_only => '',
            },
    'objects' => {
        datatype => 'ARRAY[TriggerHistoryObjectSummaryDto]',
        base_name => 'objects',
...
__PACKAGE__->openapi_types( {
    ...
    'association_object_uuid' => 'string',
    'objects_resource' => 'Resource',
...
__PACKAGE__->attribute_map( {
    'association_resource' => 'associationResource',
    'association_object_uuid' => 'associationObjectUuid',
    'objects_resource' => 'objectsResource',
    'objects_evaluated' => 'objectsEvaluated',
