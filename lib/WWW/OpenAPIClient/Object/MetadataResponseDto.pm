...
#
package WWW::OpenAPIClient::Object::MetadataResponseDto;
...
__PACKAGE__->class_documentation({description => 'Metadata response attributes with their source connector',
...
__PACKAGE__->method_documentation({
    ...
    'source_object_type' => {
        datatype => 'Resource',
        base_name => 'sourceObjectType',
        description => '',
        format => '',
        read_only => '',
            },
    'items' => {
        datatype => 'ARRAY[ResponseMetadataDto]',
        base_name => 'items',
