...
#
package WWW::OpenAPIClient::Object::RaProfileDto;
...
__PACKAGE__->method_documentation({
    ...
    'authority_instance_uuid' => {
        datatype => 'string',
        base_name => 'authorityInstanceUuid',
    ...
    'authority_instance_name' => {
        datatype => 'string',
        base_name => 'authorityInstanceName',
...
__PACKAGE__->openapi_types( {
    ...
    'name' => 'string',
    'description' => 'string',
    'authority_instance_uuid' => 'string',
    'authority_instance_name' => 'string',
...
__PACKAGE__->attribute_map( {
    ...
    'authority_instance_uuid' => 'authorityInstanceUuid',
    'authority_instance_name' => 'authorityInstanceName',
