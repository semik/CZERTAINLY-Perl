...
#
package WWW::OpenAPIClient::Object::CredentialAttributeContentData;
...
__PACKAGE__->class_documentation({description => 'Credential attribute content data',
