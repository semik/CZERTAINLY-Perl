...
#
package WWW::OpenAPIClient::Object::CustomAttributeDefinitionDetailDto;
...
__PACKAGE__->class_documentation({description => '',
                                  class => 'CustomAttributeDefinitionDetailDto',
                                  required => [], # TODO
}                                 );
