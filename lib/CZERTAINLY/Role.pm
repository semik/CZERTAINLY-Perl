...
has _cfg => ( is => 'ro',
              isa => 'CZERTAINLY::Configuration',
              default => sub { CZERTAINLY::Configuration->new() },
              );

has version_info => ( is => 'ro',
                      isa => 'HashRef',
                      default => sub { {
                          app_name => 'CZERTAINLY Core API',
                          app_version => '2.13.2-SNAPSHOT',
...
sub _build_af {
    ...
    return CZERTAINLY::ApiFactory->new(%args);
}
...
=head2 CZERTAINLY Core API version: 2.13.2-SNAPSHOT
