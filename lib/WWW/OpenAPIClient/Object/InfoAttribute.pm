...
#
package WWW::OpenAPIClient::Object::InfoAttribute;
...
__PACKAGE__->class_documentation({description => 'Info attribute contains content that is for information purpose or represents additional information for object (metadata). Its content can not be edited and is not send in requests to store.',
                                  class => 'InfoAttribute',
                                  required => [], # TODO
}                                 );
...
__PACKAGE__->method_documentation({
    ...
    'content' => {
        datatype => 'ARRAY[BaseAttributeContentDto]',
        base_name => 'content',
    ...
    'properties' => {
        datatype => 'InfoAttributeProperties',
