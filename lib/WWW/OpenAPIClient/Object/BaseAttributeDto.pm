...
#
package WWW::OpenAPIClient::Object::BaseAttributeDto;
...
__PACKAGE__->class_documentation({description => 'Base Attribute definition',
                                  class => 'BaseAttributeDto',
                                  required => [], # TODO
}                                 );
...
__PACKAGE__->method_documentation({
    ...
    'properties' => {
        datatype => 'CustomAttributeProperties',
