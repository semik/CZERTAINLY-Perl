...
#
package WWW::OpenAPIClient::Object::ComplianceRulesResponseDto;
...
__PACKAGE__->class_documentation({description => 'Rules from Compliance Provider',
                                  class => 'ComplianceRulesResponseDto',
                                  required => [], # TODO
}                                 );
