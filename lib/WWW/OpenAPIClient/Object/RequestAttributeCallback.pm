...
#
package WWW::OpenAPIClient::Object::RequestAttributeCallback;
...
__PACKAGE__->class_documentation({description => '',
                                  class => 'RequestAttributeCallback',
                                  required => [], # TODO
}                                 );
...
__PACKAGE__->openapi_types( {
    'uuid' => 'string',
    'name' => 'string',
    'path_variable' => 'HASH[string,object]',
    'request_parameter' => 'HASH[string,object]',
