...
#
package WWW::OpenAPIClient::Object::ClientCertificateRequestDto;
...
__PACKAGE__->class_documentation({description => '',
                                  class => 'ClientCertificateRequestDto',
                                  required => [], # TODO
}                                 );
...
__PACKAGE__->openapi_types( {
    ...
    'csr_attributes' => 'ARRAY[RequestAttributeDto]',
    'signature_attributes' => 'ARRAY[RequestAttributeDto]',
    'request' => 'string',
    'format' => 'CertificateRequestFormat',
    'token_profile_uuid' => 'string',
    'key_uuid' => 'string',
    'issue_attributes' => 'ARRAY[RequestAttributeDto]',
