...
#
package WWW::OpenAPIClient::Object::MetadataAttribute;
...
__PACKAGE__->class_documentation({description => 'Info attribute contains content that is for metadata. Its content can not be edited and is not send in requests to store.',
...
__PACKAGE__->method_documentation({
    ...
    'properties' => {
        datatype => 'MetadataAttributeProperties',
