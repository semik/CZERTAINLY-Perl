...
#
package WWW::OpenAPIClient::Object::SearchFieldDataDto;
...
__PACKAGE__->class_documentation({description => 'List of search fields for specified search group',
                                  class => 'SearchFieldDataDto',
                                  required => [], # TODO
}                                 );
...
__PACKAGE__->method_documentation({
    ...
    'conditions' => {
        datatype => 'ARRAY[FilterConditionOperator]',
    ...
    'platform_enum' => {
        datatype => 'PlatformEnum',
        base_name => 'platformEnum',
        description => '',
        format => '',
        read_only => '',
            },
    'attribute_content_type' => {
        ...
        base_name => 'attributeContentType',
        description => '',
        format => '',
        read_only => '',
            },
...
__PACKAGE__->openapi_types( {
    ...
    'attribute_content_type' => 'AttributeContentType',
    'value' => 'object',
    'multi_value' => 'boolean'
} );
