...
#
package WWW::OpenAPIClient::Object::DiscoveryHistoryDetailDto;
...
__PACKAGE__->class_documentation({description => '',
                                  class => 'DiscoveryHistoryDetailDto',
                                  required => [], # TODO
}                                 );
...
__PACKAGE__->method_documentation({
    ...
    'total_certificates_discovered' => {
        datatype => 'int',
        base_name => 'totalCertificatesDiscovered',
        description => 'Number of certificates that are discovered',
        format => '',
        read_only => '',
            },
    'connector_total_certificates_discovered' => {
        datatype => 'int',
        base_name => 'connectorTotalCertificatesDiscovered',
...
__PACKAGE__->openapi_types( {
    ...
    'connector_status' => 'DiscoveryStatus',
    'message' => 'string',
    'start_time' => 'DATE_TIME',
    'end_time' => 'DATE_TIME',
    'total_certificates_discovered' => 'int',
    'connector_total_certificates_discovered' => 'int',
...
__PACKAGE__->attribute_map( {
    ...
    'end_time' => 'endTime',
    'total_certificates_discovered' => 'totalCertificatesDiscovered',
    'connector_total_certificates_discovered' => 'connectorTotalCertificatesDiscovered',
