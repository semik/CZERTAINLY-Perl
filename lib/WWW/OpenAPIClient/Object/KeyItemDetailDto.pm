...
#
package WWW::OpenAPIClient::Object::KeyItemDetailDto;
...
__PACKAGE__->class_documentation({description => 'Key Objects',
                                  class => 'KeyItemDetailDto',
                                  required => [], # TODO
}                                 );
