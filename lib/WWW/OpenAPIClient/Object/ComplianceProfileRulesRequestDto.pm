...
#
package WWW::OpenAPIClient::Object::ComplianceProfileRulesRequestDto;
...
__PACKAGE__->class_documentation({description => 'Rules to be associated with the Compliance Profile. Profiles can be created without rules and can be added later',
                                  class => 'ComplianceProfileRulesRequestDto',
                                  required => [], # TODO
}                                 );
...
__PACKAGE__->method_documentation({
    ...
    'rules' => {
        datatype => 'ARRAY[ComplianceRequestRulesDto]',
        base_name => 'rules',
